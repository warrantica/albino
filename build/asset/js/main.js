...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.component('commentView', __webpack_require__(32));
	_vue2.default.component('pagination', __webpack_require__(35));
	_vue2.default.component('commentItem', __webpack_require__(38));
	_vue2.default.component('reactionView', __webpack_require__(41));
	_vue2.default.component('tips', __webpack_require__(44));
	_vue2.default.component('about', __webpack_require__(46));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\sites\\albino\\albino\\src\\js\\main.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-148a1866", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-148a1866", __vue_options__)
	  }
	})()}
	...
	exports.default = {
	  ...
	  methods: _extends({
	    ...
	    refreshTopic: function refreshTopic() {
	      ...
	      if (this.topicId !== 0) {
	        (function () {
	          var scroll = document.querySelector('.rightPane').scrollTop;
	...
	var loadTopic = exports.loadTopic = function loadTopic(_ref7, topicId) {
	  ...
	  chrome.storage.sync.get({ commentsPerPage: '5' }, function (item) {
	    ...
	    dispatch('loadMoreComments').then(function (data) {
	      ...
	      _helpers2.default.FABVisibility(state.sortedComments.length);
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    staticClass: "ics toolbarIcon-icon",
	    domProps: {
	      "textContent": _s(icon)
	    }
	  }), " ", _h('div', {
	    ref: "label",
	    staticClass: "toolbarIcon-label",
	    style: ({
	      right: offset + 'px'
	    }),
	    domProps: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('li', {
	    staticClass: "dialogue-item dialogue-item--forumSelect",
	    on: {
	      "click": loadForum
	    }
	  }, [_h('img', {
	    staticClass: "dialogue-icon",
	    attrs: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    class: {
	      'topicItem--active': isActive
	    },
	    on: {
	      "click": loadTopic
	    }
	  }, [_h('div', {
	    staticClass: "topicItem-thumbnail"
	  }, [_h('img', {
	    staticClass: "topicItem-thumbnailImage",
	    attrs: {
	      "src": thumbnail
	    }
	  })]), " ", _h('div', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    staticClass: "topicItem",
	    class: {
	      'topicItem--active': isActive, 'topicItem--top': data.isTop
	    },
	    on: {
	      "click": loadTopic
	    }
