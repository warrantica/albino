...
$(function(){
  ...
  var forumInfo = {
    food: 'ก้นครัว',
    chalermkrung: 'เฉลิมกรุง',
    blueplanet: 'บลูแพลนเน็ต',
    '': 'รวมมิตร',
    siam: 'สยามสแควร์',
    greenzone: 'กรีนโซน',
    chalermthai: 'เฉลิมไทย',
    tvshow: 'บางขุนพรหม',
    ratchada: 'รัชดา',
    lumpini: 'สวนลุมพินี',
    camera: 'กล้อง',
    ...
    silom: 'สีลม',
    gallery: 'แกลเลอรี่',
    siliconvalley: 'ซิลิคอนวัลเลย์',
    pantip: 'พันทิป',
    social: 'ศาลาประชาคม',
    wahkor: 'หว้ากอ',
    klaibann: 'ไกลบ้าน',
    beauty: 'โต๊ะเครื่องแป้ง',
    region: 'ภูมิภาค',
    religious: 'ศาสนา',
    library: 'ห้องสมุด',
    jatujak: 'จตุจักร',
  ...
  $('#bestTopicHeader').on('click', function(e){
    $('#bestTopicHeader').toggleClass('active');
    $('#bestTopicList').toggleClass('active');
  });
