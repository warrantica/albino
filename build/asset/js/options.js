...
/***/ function(module, exports, __webpack_require__) {
	...
	var _options = __webpack_require__(57);

	var _options2 = _interopRequireDefault(_options);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_vue2.default.component('themeItem', __webpack_require__(60));
	_vue2.default.component('themePreview', __webpack_require__(65));

	var vm = new _vue2.default({
	  render: function render(h) {
	    return h(_options2.default);
	  }
	}).$mount('#app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\sites\\albino\\albino\\src\\js\\options.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-191628ba", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-191628ba", __vue_options__)
	  }
	})()}
	...
	exports.default = {
	  data: function data() {
	    return {
	      ...
	      themes: _vars2.default.themes,
	      fontSizes: _vars2.default.fontSizes,
	      fontFaces: _vars2.default.fontFaces,
	      options: {
	        defaultForum: 'all',
	        theme: 'default',
	        fontSize: '26',
	  ...
	  methods: {
	    saveOptions: function saveOptions() {
	      ...
	      chrome.storage.sync.set(this.options, function () {
	        //Notify user
	        _this.saveButtonState = 'success';
	        window.setTimeout(function () {
	          _this.saveButtonState = 'default';
	  ...
	  mounted: function mounted() {
	    ...
	    //restore options
	    chrome.storage.sync.get(this.options, function (item) {
	      return _this2.options = item;
	    });
	  }
	}; //
	//
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (options.defaultForum),
	      expression: "options.defaultForum"
	    }],
	    attrs: {
	      "id": "defaultForum",
	      "name": "defaultForum"
	    ...
	    on: {
	      "change": function($event) {
	        options.defaultForum = Array.prototype.filter.call($event.target.options, function(o) {
	          return o.selected
	        }).map(function(o) {
	    ...
	    staticClass: "formGroup col2"
	  }, [_h('div', {
	    staticClass: "colItem"
	  }, [_l((themes), function(theme) {
	    return _h('theme-item', {
	      attrs: {
	        "name": theme.name,
	        "label": theme.label,
	    ...
	    on: {
	      "change": function($event) {
	        options.fontSize = Array.prototype.filter.call($event.target.options, function(o) {
	          return o.selected
	        }).map(function(o) {
	          return "_value" in o ? o._value : o.value
	        })[0]
	    ...
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (options.fontFace),
	      expression: "options.fontFace"
	    }],
	    attrs: {
	      "id": "fontFace",
	      "name": "fontFace"
	    ...
	    on: {
	      "change": function($event) {
	        options.fontFace = Array.prototype.filter.call($event.target.options, function(o) {
	          return o.selected
	        }).map(function(o) {
	          return "_value" in o ? o._value : o.value
	        })[0]
	    ...
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (options.commentsPerPage),
	      expression: "options.commentsPerPage"
	    }],
	    attrs: {
	      "id": "commentsPerPage",
	    ...
	    on: {
	      "change": function($event) {
	        options.commentsPerPage = Array.prototype.filter.call($event.target.options, function(o) {
	          return o.selected
	        }).map(function(o) {
	          return "_value" in o ? o._value : o.value
	        })[0]
	  ...
	  }, [_m(10), " ", _m(11), " ", _m(12), " ", _m(13), " ", _m(14)])]), " ", _h('div', {
	    staticClass: "buttonContainer"
	  }, [_h('button', {
	    staticClass: "saveButton",
	    class: {
	      'saveButton--success': this.saveButtonState == 'success'
	    },
	    on: {
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (saveButtonState == 'success'),
	      expression: "saveButtonState == 'success'"
	    }],
	    staticClass: "saveButton-success"
	  }, [_m(15)])]), " ", _m(16)])])])])
	}},staticRenderFns: [function (){with(this) {
	  return _h('header', [_h('img', {
	    attrs: {
	      "src": "asset/img/logoHover.png",
	      "alt": "Albino for Pantip"
	    }
	  }), " ", _h('h1', ["ตั้งค่า"])])
	}},function (){with(this) {
	  return _h('h2', ["ทั่วไป"])
	  ...
	  return _h('h3', ["การจัดวาง"])
	}},function (){with(this) {
	  return _h('label', {
	    attrs: {
	      "for": "commentsPerPage"
	    }
	  }, ["จำนวนความเห็นต่อหน้า"])
	}},function (){with(this) {
	  return _h('option', {
	    attrs: {
	      "value": "5"
	  ...
	  return _h('span', {
	    staticClass: "saveButton-text"
	  }, ["เซฟ"])
	}}]}
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-191628ba", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\sites\\albino\\albino\\src\\js\\components\\themeItem.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-232ae26c"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-232ae26c", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-232ae26c", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] themeItem.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-232ae26c&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./themeItem.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-232ae26c&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./themeItem.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\ninput[data-v-232ae26c]{ display: none;\n}\nlabel[data-v-232ae26c]{\n  display: block;\n  padding: 5px 10px;\n  transition: all .2s ease;\n  cursor: pointer;\n}\n.colorSample[data-v-232ae26c]{\n  display: inline-block;\n  margin-right: 10px;\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  vertical-align: middle;\n  position: relative; top: 0; left: 0;\n  transition: all .2s ease;\n}\n.baseColor[data-v-232ae26c]{\n  width: 26px;\n  height: 13px;\n  border-radius: 0 0 26px 26px;\n  margin: 16px 0 0 3px;\n}\n.accentSample[data-v-232ae26c]{\n  position: absolute;\n  bottom: 0; right: 0;\n  width: 12px;\n  height: 12px;\n  border-radius: 50%;\n}\n.labelText[data-v-232ae26c]{\n  display: inline-block;\n  font-size: 16px;\n  vertical-align: middle;\n}\ninput:checked + label[data-v-232ae26c]{\n  background: #e3e3e3;\n}\ninput:checked + label .colorSample[data-v-232ae26c], label:hover .colorSample[data-v-232ae26c]{\n  transform: scale(1.1);\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: ($parent.options.theme),
	      expression: "$parent.options.theme"
	    }],
	    attrs: {
	      "type": "radio",
	      "name": "theme",
	    ...
	    domProps: {
	      "value": name,
	      "checked": _q($parent.options.theme, name)
	    },
	    on: {
	      "change": function($event) {
	        $parent.options.theme = name
	      }
	    }
	  }), " ", _h('label', {
	    attrs: {
	    ...
	    style: ({
	      background: baseData.fore
	    })
	  }), " ", _h('div', {
	    staticClass: "accentSample",
	    style: ({
	      background: accent
	    })
	  })]), " ", _h('div', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-232ae26c", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\sites\\albino\\albino\\src\\js\\components\\themePreview.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-b22d513e"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-b22d513e", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-b22d513e", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] themePreview.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b22d513e&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./themePreview.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b22d513e&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./themePreview.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\ndiv[data-v-b22d513e]{ transition: background-color .5s ease;\n}\n.themePreview[data-v-b22d513e]{\n  display: block;\n  width: 80%;\n  height: 120px;\n  margin: 20px auto;\n  vertical-align: top;\n  box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);\n}\n.container[data-v-b22d513e]{\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-flow: row nowrap;\n  position: relative; top: 0; left: 0;\n}\n.sidebar[data-v-b22d513e]{\n  display: inline-block;\n  width: 30%;\n}\n.belly[data-v-b22d513e]{\n  flex: 1;\n}\n.header[data-v-b22d513e]{\n  height: 20px;\n  padding: 0 2px;\n  color: #fff;\n  font-size: 10px;\n  line-height: 20px;\n}\n.content[data-v-b22d513e]{\n  width: 50%;\n  height: 60px;\n  margin: 5px auto 0 auto;\n}\n.fab[data-v-b22d513e]{\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  position: absolute;\n  bottom: 5px; right: 5px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-b22d513e", module.exports)
	  }
	}
